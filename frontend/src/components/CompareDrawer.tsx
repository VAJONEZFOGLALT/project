...
export default function CompareDrawer({
  ...
  return (
    <>
      <button type="button" className="compare-tab" onClick={() => setOpen(true)}>
      ...
      <div className={`compare-drawer ${open ? 'open' : ''}`}>
        ...
        <div className="compare-drawer-actions">
          ...
          <button type="button" className="btn-primary" onClick={() => setShowTable(true)} disabled={items.length < 2}>Compare</button>
        </div>
      </div>
