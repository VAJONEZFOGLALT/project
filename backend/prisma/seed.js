...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var users, i, user, products, i, product, i, user, order, total, numItems, j, product, quantity, price;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 10:
                    order = _a.sent();
                    total = 0;
                    numItems = faker_1.faker.number.int({ min: 1, max: 4 });
                    j = 0;
                    _a.label = 11;
                case 11:
                    if (!(j < numItems)) return [3 /*break*/, 14];
                    product = products[faker_1.faker.number.int({ min: 0, max: products.length - 1 })];
                    quantity = faker_1.faker.number.int({ min: 1, max: 5 });
                    price = product.price * quantity;
                    return [4 /*yield*/, prisma.orderItems.create({
                            data: {
                                orderId: order.id,
