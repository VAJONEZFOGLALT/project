  ...
  const handleToggleCompare = async () => {
    ...
    if (compareIds.includes(product.id)) {
      ...
      try {
        ...
        showToast(err.message || 'Nem sikerült hozzáadni az összehasonlításhoz', 'error');
      }
    }
          ...
          <div className="detail-image-frame">
            ...
            <div className="detail-media-actions">
              ...
              <button 
                ...
                title={!isAuthenticated ? t('products.logInToCompare') : compareIds.includes(product.id) ? 'Eltávolítás az összehasonlításból' : 'Hozzáadás az összehasonlításhoz'}
              >
        ...
        <div className="detail-right">
          ...
          <div className="detail-highlights">
            <div className="highlight-item">
              ...
              <span className="highlight-value">2-4 munkanap</span>
            </div>
            <div className="highlight-item">
              <span className="highlight-label">{t('products.returns')}</span>
              <span className="highlight-value">30 napos visszaküldés</span>
            </div>
            <div className="highlight-item">
              <span className="highlight-label">{t('products.warranty')}</span>
              <span className="highlight-value">12 hónap</span>
            </div>
          </div>
              ...
              <div className="reviews-preview-list">
                {reviews.slice(0, 3).map((rev) => (
                  <div key={rev.id} className="review-card">
                    ...
                    <div className="review-meta">Szerző: {rev.userName}</div>
                  </div>
                ))}
              </div>
              {reviews.length > 3 && (
