        ...
        {loading ? (
          ...
          <>
            <div className="carousel-container">
              <button className="carousel-btn carousel-btn-prev" onClick={handlePrevCarousel} aria-label="Előző">
                ❮
              </button>
              ...
              <button className="carousel-btn carousel-btn-next" onClick={handleNextCarousel} aria-label="Következő">
                ❯
              </button>
            </div>
            <div className="carousel-indicators">
              {Array.from({ length: Math.ceil(products.length / 4) }).map((_, idx) => (
                <button
                  ...
                  aria-label={`Ugrás a(z) ${idx + 1}. diára`}
                />
              ))}
            </div>
          </>
